...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="/storage/emulated/0/Download/IMG-20250124-WA0018.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>Rithish kumar A</h1>
            <p>Am student</p>
        </div>
    </header>
